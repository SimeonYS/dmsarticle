...
from ..items import DmsarticleItem
...
payload="action=get_more_posts&offset={}&category_id=8"
headers = {
...
class DmsarticleSpider(scrapy.Spider):
	...
	def parse_post(self, response):
		...
		item = ItemLoader(item=DmsarticleItem(), response=response)
